...
import micImg from "../assets/mic.jpeg";
import speImg from "../assets/spe.jpg";
import proImg from "../assets/pro.webp";
import whiImg from "../assets/whi.jpg";
...
const defaultAddOns: Item[] = [
  { id: "mic", name: "Microphone", unitCost: 45, quantity: 0 },
  { id: "spe", name: "Speaker", unitCost: 35, quantity: 0 },
  { id: "pro", name: "Projector", unitCost: 200, quantity: 0 },
  { id: "whi", name: "Whiteboard", unitCost: 80, quantity: 0 },
  { id: "sign", name: "Signage", unitCost: 80, quantity: 0 },
];
