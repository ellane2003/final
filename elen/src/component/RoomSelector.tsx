...
import confeImg from '../assets/confe.jpg';
import presentImg from '../assets/present.jpg';
import largeImg from '../assets/large.avif';
...
const rooms: Room[] = [
  { id: 'aud', name: 'Auditorium Hall', capacity: 200, unitCost: 5500, image: audiImg },
  { id: 'conf', name: 'Conference Room', capacity: 15, unitCost: 1500, image: confeImg },
  { id: 'pres', name: 'Presentation Room', capacity: 50, unitCost: 3500, image: presentImg },
  { id: 'large', name: 'Large Meeting Room', capacity: 10, unitCost: 1000, image: largeImg },
  { id: 'small', name: 'Small Meeting Room', capacity: 5, unitCost: 800, image: smallImg },
];
